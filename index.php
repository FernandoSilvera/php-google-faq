...
$db = [
  [
    "title" => [
      "tag" => "h2",
      "content" => "How are you implementing the recent Court of Justice of the European Union (CJEU) decision on the right to be forgotten?",
    ],
    "paragraphs" => [
  ...
  [
    "title" => [
      "tag" => "h2",
      "content" => "How does Google protect my privacy and keep my information secure?",
    ],
    "paragraphs" => [
  ...
  [
    "title" => [
      "tag" => "h2",
      "content" => "Why is my account associated with a country?",
    ],
    "paragraphs" => [
  ...
  [
    "title" => [
      "tag" => "h3",
      "content" => "Determining the country associated with your account",
    ],
    "paragraphs" => [
  ...
  [
    "title" => [
      "tag" => "h2",
      "content" => "How can I remove information about myself from Google's search results?",
    ],
    "paragraphs" => [
